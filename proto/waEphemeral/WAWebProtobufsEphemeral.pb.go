...
var file_waEphemeral_WAWebProtobufsEphemeral_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c,
}
...
var file_waEphemeral_WAWebProtobufsEphemeral_proto_goTypes = []interface{}{
...
func file_waEphemeral_WAWebProtobufsEphemeral_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waEphemeral_WAWebProtobufsEphemeral_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
