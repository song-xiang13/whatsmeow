...
var file_waWinUIApi_WAWinUIApi_proto_rawDesc = []byte{
	...
	0x57, 0x69, 0x6e, 0x55, 0x49, 0x41, 0x70, 0x69,
}
...
var file_waWinUIApi_WAWinUIApi_proto_goTypes = []interface{}{
...
func file_waWinUIApi_WAWinUIApi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waWinUIApi_WAWinUIApi_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
