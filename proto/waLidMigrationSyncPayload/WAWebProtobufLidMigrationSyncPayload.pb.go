...
var file_waLidMigrationSyncPayload_WAWebProtobufLidMigrationSyncPayload_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x64, 0x22, 0xc1, 0x01, 0x0a, 0x1e, 0x4c, 0x49, 0x44, 0x4d, 0x69, 0x67, 0x72, 0x61,
	...
	0x4c, 0x69, 0x64, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x3a, 0x0a, 0x18, 0x63,
	0x68, 0x61, 0x74, 0x44, 0x62, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x18, 0x63,
	0x68, 0x61, 0x74, 0x44, 0x62, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x74, 0x6f, 0x2f, 0x77, 0x61, 0x4c, 0x69, 0x64, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x79, 0x6e, 0x63, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
}
...
var file_waLidMigrationSyncPayload_WAWebProtobufLidMigrationSyncPayload_proto_goTypes = []interface{}{
...
func file_waLidMigrationSyncPayload_WAWebProtobufLidMigrationSyncPayload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waLidMigrationSyncPayload_WAWebProtobufLidMigrationSyncPayload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LIDMigrationMapping); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_waLidMigrationSyncPayload_WAWebProtobufLidMigrationSyncPayload_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LIDMigrationMappingSyncPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
