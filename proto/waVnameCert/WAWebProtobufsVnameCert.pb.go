...
var file_waVnameCert_WAWebProtobufsVnameCert_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x77, 0x61, 0x56, 0x6e, 0x61, 0x6d, 0x65, 0x43, 0x65, 0x72,
	0x74,
}
...
var file_waVnameCert_WAWebProtobufsVnameCert_proto_goTypes = []interface{}{
...
func file_waVnameCert_WAWebProtobufsVnameCert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waVnameCert_WAWebProtobufsVnameCert_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
