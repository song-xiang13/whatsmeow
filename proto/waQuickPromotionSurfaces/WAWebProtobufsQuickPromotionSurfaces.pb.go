...
var file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_rawDesc = []byte{
	...
	0x4f, 0x52, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x4e, 0x4f, 0x52, 0x10, 0x03, 0x42, 0x42, 0x5a,
	...
	0x6f, 0x77, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x77, 0x61, 0x51, 0x75, 0x69, 0x63, 0x6b,
	0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x75, 0x72, 0x66, 0x61, 0x63, 0x65,
	0x73,
}
...
var file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_goTypes = []interface{}{
...
func file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_waQuickPromotionSurfaces_WAWebProtobufsQuickPromotionSurfaces_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
